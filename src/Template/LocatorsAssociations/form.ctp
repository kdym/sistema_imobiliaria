            ...
            <div class="box-body">
                <div class="percentage-sliders">
                    <div class="row vertical-center-row" id="main-locator"
                         data-locator-id="<?php echo $locator['id'] ?>">
                        ...
                        <div class="col-md-10 col-sm-12">
                            <h1><?php echo $locator['nome'] ?></h1>

                            <div class="row vertical-center-row">
                                <div class="col-md-10 col-sm-10 col-xs-10">
                                    <input type="text" value="" id="main-slider" class="form-control"
                                           data-slider-enabled="<?php echo !empty($locator['locators_associations']) ?>"
                    ...
                    <?php foreach ($locator['locators_associations'] as $a) { ?>
                        <div class="row vertical-center-row associated-locator-row"
                            ...
                            <div class="col-md-10 col-sm-12">
                                <h1><?php echo $a['associated']['nome'] ?></h1>
